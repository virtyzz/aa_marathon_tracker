...
const schema=z.object({name:z.string().trim().min(1).max(40),server:z.string().trim().max(50).nullable().optional(),note:z.string().trim().max(500).nullable().optional(),gameAccountId:z.string().cuid().optional()});
