...
type Dialog = { kind: "edit-week"; week: Week; value: string; startsAt: string; endsAt: string } | { kind: "edit-task"; task: Task; value: string } | { kind: "confirm"; title: string; text: string; confirm: string; action: () => Promise<void>; danger?: boolean };
