...
export default function AdminPage() {
  ...
  const submitDialog = async () => {
    ...
    try {
      ...
      else if (dialog.kind === "edit-task") { const title = dialog.value.trim(); if (!title || !dialog.description.trim()) throw new Error("Укажите название и описание задания"); await call(`/api/admin/tasks/${dialog.task.id}`, "PATCH", { title, description: dialog.description.trim(), location: dialog.location.trim() || null, xp: dialog.xp, maxCompletions: dialog.maxCompletions, allowedDays: dialog.allowedDays }); setMessage("Задание обновлено"); }
